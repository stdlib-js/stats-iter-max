...
```javascript
itermax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-max@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-iter-max/tags). For example,

```javascript
itermax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-max@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var itermax = require( 'path/to/vendor/umd/stats-iter-max/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-max/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-iter-max/actions/workflows/test.yml?query=branch:v0.2.1
...
[deno-readme]: https://github.com/stdlib-js/stats-iter-max/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-iter-max/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-iter-max/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-iter-max/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-iter-max/blob/esm/README.md
